...
const travelTags = [
    "Adventure", "Culture", "Food", "Nature", "Winter", "Road Trips", "Beach", "Northern Lights", "Cities"
];
            ...
            <div className="max-w-7xl mx-auto py-10 px-5 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 text-sm text-gray-700">
                ...
                <div className="col-span-1">
                    ...
                    <p className="text-gray-600 mb-6">
                        Plan, explore, and relive your journeys — all in one place.
                    </p>
                    <div className="flex gap-4">
                        ...
                        <a href="#" className="hover:text-green-600 transition"><Mail className="w-5 h-5" /></a>
                    </div>
                </div>
                ...
                <div className="col-span-1">
                    ...
                    <form className="flex items-center bg-white border border-gray-300 rounded-md overflow-hidden shadow-sm">
                        <input
                            type="email"
                ...
                <div>
                    ...
                    <ul className="space-y-2">
                        ...
                        <li><a href="#" className="hover:text-blue-600 transition">Collaborators</a></li>
                        <li><a href="#" className="hover:text-blue-600 transition">Create Trip</a></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <div className="flex flex-wrap gap-2">
                        {travelTags.map((tag) => (
                            <span
                                key={tag}
                                className="px-3 py-1.5 bg-gray-200 text-gray-800 text-xs rounded-full hover:bg-blue-100 cursor-pointer transition"
                            >
                                #{tag}
                            </span>
                        ))}
